...
$mime_types = [
      ...
      '.ivr'  => ['i-world/i-vrml','application/x-livescreen'],
      '.jam'  => 'audio/x-jam',
      ...
      '.xlsx' => ['application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'], //adicionado
      ...
      '.zip' => ['application/x-compressed','application/x-zip-compressed','application/zip','application/octet-stream','multipart/x-zip'],
      '.zoo' => 'application/octet-stream',
      '.zsh' => 'text/x-script.zsh)'
    ];

/* Verifica o valor no array */
function inArray($value, $array){
        foreach ($array as $v):
            if ( is_array($v) and in_array($value,$v) ) return true;
